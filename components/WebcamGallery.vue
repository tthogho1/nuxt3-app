  ...
  <div class="container-fluid px-0 d-flex justify-content-center">
    ...
    >
      ...
      <div class="col" v-for="webcam in webcams" :key="webcam.webcamid">
        <div class="card h-100">
          ...
          <div class="card-body">
            <button
              class="link-button"
              @click="gotoMap(webcam.location.latitude, webcam.location.longitude)"
            >
              {{ webcam.title }}
            </button>
          </div>
      ...
      <div class="col" v-for="searchedData in searchedDataArray" :key="searchedData.id">
        <div class="card h-100">
          <div>
            <img class="card-img-top" :src="searchedData.urls.small" alt="Searched data image" />
          </div>
          <div class="card-body">
            <button
              class="link-button"
              @click="gotoMap(searchedData.location.latitude, searchedData.location.longitude)"
            >
